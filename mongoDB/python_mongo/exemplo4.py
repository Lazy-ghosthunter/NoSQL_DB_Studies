...
if resultado:
    acao = input("você quer atualizar ou excluir os registros encontrados")
    if acao.lower() == 'a':
        ...
        del_count = delete_mongo(campo, valor)
        print(f'{del_count} documento(s) excluido(s).')

        resultado_restante = search_mongo(campo,valor)
        print("Resultado após a exclusão: ")
        for doc in resultado_restante:
            print(doc)
else: 
    print('Nenhum resultado encontrado para a pesquisa realizada! :(')
